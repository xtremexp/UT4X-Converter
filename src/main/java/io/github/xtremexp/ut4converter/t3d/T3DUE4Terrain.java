...
import io.github.xtremexp.ut4converter.export.UTPackageExtractor;
import io.github.xtremexp.ut4converter.tools.Geometry;
import io.github.xtremexp.ut4converter.ucore.UPackageRessource;
import io.github.xtremexp.ut4converter.ucore.ue2.TerrainLayer;
import io.github.xtremexp.ut4converter.ucore.ue4.LandscapeCollisionComponent;
import io.github.xtremexp.ut4converter.ucore.ue4.LandscapeComponent;
import io.github.xtremexp.ut4converter.ucore.ue4.LandscapeComponentAlphaLayer;
...
public class T3DUE4Terrain extends T3DActor {
	...
	public T3DUE4Terrain(final T3DUE3Terrain ue3Terrain) {
		...
		for (io.github.xtremexp.ut4converter.ucore.ue3.TerrainLayer terrainLayer : ue3Terrain.getTerrainLayers()) {
	...
	private Map<Integer, List<Integer>> fixAlphaLayersValuesByTerrainLayerIndex(T3DUE3Terrain ue3Terrain) {
		...
		for (int terrainLayerIdx = 0; terrainLayerIdx < ue3Terrain.getTerrainLayers().size(); terrainLayerIdx++) {
			...
			final io.github.xtremexp.ut4converter.ucore.ue3.TerrainLayer terrainLayer = ue3Terrain.getTerrainLayers().get(terrainLayerIdx);
