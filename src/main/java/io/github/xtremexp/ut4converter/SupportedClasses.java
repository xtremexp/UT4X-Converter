...
import io.github.xtremexp.ut4converter.t3d.Camera;
import io.github.xtremexp.ut4converter.t3d.DecalActor;
import io.github.xtremexp.ut4converter.t3d.DefensePoint;
import io.github.xtremexp.ut4converter.t3d.DomPoint;
import io.github.xtremexp.ut4converter.t3d.HeightFog;
import io.github.xtremexp.ut4converter.t3d.T3DActor;
import io.github.xtremexp.ut4converter.t3d.T3DAlarmPoint;
import io.github.xtremexp.ut4converter.t3d.T3DBrush;
import io.github.xtremexp.ut4converter.t3d.T3DCounter;
import io.github.xtremexp.ut4converter.t3d.T3DDecoration;
import io.github.xtremexp.ut4converter.t3d.T3DDispatcher;
import io.github.xtremexp.ut4converter.t3d.T3DDynamicAmbientSound;
import io.github.xtremexp.ut4converter.t3d.T3DGradualMover;
import io.github.xtremexp.ut4converter.t3d.T3DJumpPad;
import io.github.xtremexp.ut4converter.t3d.T3DLevelInfo;
import io.github.xtremexp.ut4converter.t3d.T3DLiftExit;
import io.github.xtremexp.ut4converter.t3d.T3DLight;
import io.github.xtremexp.ut4converter.t3d.T3DMatch;
import io.github.xtremexp.ut4converter.t3d.T3DMover;
import io.github.xtremexp.ut4converter.t3d.T3DMoverSM;
import io.github.xtremexp.ut4converter.t3d.T3DMusicEvent;
import io.github.xtremexp.ut4converter.t3d.T3DNote;
import io.github.xtremexp.ut4converter.t3d.T3DPlayerStart;
import io.github.xtremexp.ut4converter.t3d.T3DSound;
import io.github.xtremexp.ut4converter.t3d.T3DSpawnPoint;
import io.github.xtremexp.ut4converter.t3d.T3DSpecialEvent;
import io.github.xtremexp.ut4converter.t3d.T3DStaticMesh;
import io.github.xtremexp.ut4converter.t3d.T3DTeleporter;
import io.github.xtremexp.ut4converter.t3d.T3DTranslatorEvent;
import io.github.xtremexp.ut4converter.t3d.T3DTriggerLight;
import io.github.xtremexp.ut4converter.t3d.T3DTriggerVolume;
import io.github.xtremexp.ut4converter.t3d.T3DUE1Trigger;
import io.github.xtremexp.ut4converter.t3d.T3DUE2Terrain;
import io.github.xtremexp.ut4converter.t3d.T3DUE3Terrain;
import io.github.xtremexp.ut4converter.t3d.T3DZoneInfo;
import io.github.xtremexp.ut4converter.t3d.WeaponLocker;
import io.github.xtremexp.ut4converter.t3d.ue1.BreakingGlass;
import io.github.xtremexp.ut4converter.t3d.ue1.ExplodingWall;
import io.github.xtremexp.ut4converter.t3d.ue1.ExplosionChain;
import io.github.xtremexp.ut4converter.t3d.ue1.SmokeGenerator;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DCarcass;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DEarthquake;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DFlockPawn;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DPatrolPoint;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DScriptedPawn;
import io.github.xtremexp.ut4converter.t3d.ue1.UBLight;
import io.github.xtremexp.ut4converter.t3d.*;
import io.github.xtremexp.ut4converter.t3d.ue1.*;
import io.github.xtremexp.ut4converter.t3d.ue1.T3DThingFactory;
import io.github.xtremexp.ut4converter.t3d.ue2.u2.T3DAlarmTrigger;
import io.github.xtremexp.ut4converter.ucore.UnrealEngine;
...
import static io.github.xtremexp.ut4converter.ucore.UnrealEngine.UE4;
import static io.github.xtremexp.ut4converter.ucore.UnrealEngine.UE5;
...
public class SupportedClasses {
	...
	private void initialize() {
		...
		registerUClass(mapConverter.isFrom(UnrealEngine.UE1) ? T3DMover.class : T3DMoverSM.class, "Mover", "AttachMover", "AssertMover", "RotatingMover", "ElevatorMover", "MixMover", "GradualMover",
				...
				// Harry Potter 2
				"ElevatorMover", "GridMover", "GridMover2");
