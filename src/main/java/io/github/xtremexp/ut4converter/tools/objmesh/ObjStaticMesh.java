...
import io.github.xtremexp.ut4converter.tools.t3dmesh.Vertex;
import io.github.xtremexp.ut4converter.tools.vertmesh.FJSMeshTri;
import io.github.xtremexp.ut4converter.tools.vertmesh.VertMesh;
    ...
    public ObjStaticMesh(final StaticMesh t3dSm) {
        ...
        for (final Triangle t3dTriangle : t3dSm.getTriangles()) {
            ...
            for (final Vertex t3dVertex : t3dTriangle.getVertices()) {
                ...
                t3dVertex.getUv().y = -t3dVertex.getUv().y;
