...
public interface TGAConstants {
	...
	/**
	 * <p>
	 * An image type indicating an RLE (run-length encoded) color-mapped
	 * (indexed) image.
	 * </p>
	 */
	int RLE_COLOR_MAP = 9;
	...
	/**
	 * <p>
	 * An image type indicating an RLE (run-length encoded) black and white
	 * (monochrome) image.
	 * </p>
	 */
	int RLE_MONO = 11;
	...
	/**
	 * <p>
	 * The bit of the image descriptor field (5.5) indicating that the first
	 * pixel should be at the left or the right.
	 * </p>
	 */
	 ...
	 * <p>
	 * The bit of the image descriptor field (5.5) indicating that the first
	 * pixel should be at the bottom or the top.
	 * </p>
	 */
