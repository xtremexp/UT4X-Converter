...
/**
 * <p>
 * The image metadata format for a TGA image type. At this time there are no
 * elements in the format (i.e.
 ...
 * @version $Id: TGAImageMetadataFormat.java,v 1.1 2005/04/12 11:23:53 ornedan
 *          Exp $
 * @since 1.0
 */
...
public class TGAImageMetadataFormat extends IIOMetadataFormatImpl {
	 ...
	 * {@linkjavax.imageio.metadata.IIOMetadataFormat}. It is created lazily.
	 * </p>
	 */
	...
	private TGAImageMetadataFormat() {
		...
		// repeat
		super(TGAImageReaderSpi.NATIVE_IMAGE_METADATA_FORMAT_NAME, CHILD_POLICY_REPEAT);
	...
	/**
	 * <p>
	 * Retrieves the singleton instance of <code>TGAMetadataformat</code>. The
