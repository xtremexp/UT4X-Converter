 ...
 * 
 * <p>
 * See <a href="http://organicbit.com/closecombat/formats/tga.html">format</a>,
 * <a href="http://www.opennet.ru/docs/formats/targa.pdf">format</a> or <a
 * href="http://netghost.narod.ru/gff/graphics/summary/tga.htm">format</a> for
 * header information.
 * </p>
 * 
 * @author Rob Grzywinski <a
 *         href="mailto:rgrzywinski@realityinteractive.com">rgrzywinski
 *         @realityinteractive.com</a>
...
public class TGAHeader {
	...
	/**
	 * <p>
	 * Does this TGA have an associated color map? <code>1</code> indicates that
	 * there is a color map. <code>0</code> indicates no color map.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The type of image. See the image type constants in
	 * {@link com.realityinteractive.imageio.tga.TGAConstants} for allowed
	 * values.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * An image is compressed if its image type is
	 * {@link TGAConstants#RLE_COLOR_MAP}, {@link TGAConstants#RLE_TRUE_COLOR},
	 * or {@link TGAConstants#RLE_MONO}.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The computed size of the color map field in <code>byte</code>s. This is
	 * determined from the <code>numberColorMapEntries</code> and
	 * <code>colorMapEntrySize</code>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The horizontal ordering of the pixels as determined from the image
	 * descriptor. By default the order is left to right.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The offset to the color map data. This value is not defined if there is
	 * no color map (see <code>hasColorMap</code>).
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Constructs a TGA header that will be populated by setters or directly
	...
	/**
	 * <p>
	 * Constructs and populates a TGA header from the specified
	 * {@link javax.imageio.stream.ImageInputStream}.
	 * </p>
	 * 
	 * @param inputStream
	 *            the <code>ImageInputStream</code> from which the header data
	 *            is read
	 * @throws IOException
	 *             if there was an I/O error while reading the header data
	 */
	public TGAHeader(final ImageInputStream inputStream) throws IOException {
		// read the data
	...
	/**
	 * <p>
	 * Reads and populates the header from the specifed
	 * {@link javax.imageio.stream.ImageInputStream}. Any existing values will
	 * be over written.
	 * </p>
	 * 
	 * <p>
	 * The <code>ImageInputStream</code> will be changed as a result of this
	 ...
	 *             if there was an I/O error while reading the header data
	 */
	public void readHeader(final ImageInputStream inputStream) throws IOException {
		// read in the header as per the spec
		idLength = inputStream.readUnsignedByte();

		hasColorMap = (inputStream.readUnsignedByte() == 1); // 1 == true, 0 ==
																// false
		...
		isCompressed = ((imageType == TGAConstants.RLE_COLOR_MAP) || (imageType == TGAConstants.RLE_TRUE_COLOR) || (imageType == TGAConstants.RLE_MONO));
	...
	/**
	 * <p>
	 * Retrieves the type of image. See the image type constants in
	 * {@link com.realityinteractive.imageio.tga.TGAConstants} for allowed
	 * values.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Retrieves if this image is compressed. If the image type is
	 * {@link TGAConstants#RLE_COLOR_MAP}, {@link TGAConstants#RLE_TRUE_COLOR},
	 * or {@link TGAConstants#RLE_MONO} then the image is compressed.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Retrieves the horizontal coordinate for the lower-left corner of the
	 * image.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Returns if this image is left-to-right (<code>true</code>) or right-
	 * to-left (<code>false</code>).
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Returns if this image is bottom-to-top (<code>true</code>) or top-to-
	 * bottom (<code>false</code>).
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Retrieves the offset to the color map data. If there is no color map (
	 * {@link #hasColorMap()} returns <code>false</code>) then this is
	 * undefined.
	 * </p>
	 */
	...
	public String debugString() {
		return "TGAHeader[" + "type="
				+ getImageTypeString()
				+ ", "
				+ (hasColorMap ? ("firstColorMapEntryIndex=" + firstColorMapEntryIndex + ", " + "numberColorMapEntries=" + numberColorMapEntries + ", " + "bitsPerColorMapEntry="
						+ bitsPerColorMapEntry + ", " + "totalColorMapEntrySize=" + colorMapSize + ", ") : "") + "isCompressed=" + isCompressed + ", " + "xOrigin=" + xOrigin + ", " + "yOrigin="
				+ yOrigin + ", " + "width=" + width + ", " + "height=" + height + ", " + "bitsPerPixel=" + bitsPerPixel + ", " + "samplesPerPixel=" + getSamplesPerPixel() + "]";
	}
}
// =============================================================================
/*
