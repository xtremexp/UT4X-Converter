...
/**
 * <p>
 * A service provider for reading TGA images. Only
 * {@link javax.imageio.stream.ImageInputStream} input types are allowed. See
 * {@link com.realityinteractive.imageio.tga.TGAImageReader} for supported
 * features.
 * </p>
 * 
...
public class TGAImageReaderSpi extends ImageReaderSpi {
	 ...
	 * </p>
	 */
	static final String[] MIME_TYPES = { "application/tga", "application/x-tga", "application/x-targa", "image/tga", "image/x-tga", "image/targa", "image/x-targa" };
	...
	/**
	 * <p>
	 * Constructs an {@link javax.imageio.spi.ImageReaderSpi} that accepts
	 * {@link javax.imageio.stream.ImageInputStream} as its input type.
	 * </p>
	 * 
	 * @see javax.imageio.spi.ImageReaderSpi#ImageReaderSpi()
	 */
	public TGAImageReaderSpi() {
		super(VENDOR_NAME, VERSION, FORMAT_NAMES, SUFFIXES, MIME_TYPES, READER_CLASSNAME, ImageReaderSpi.STANDARD_INPUT_TYPE, WRITER_SPI_CLASSNAMES, SUPPORTS_STANDARD_STREAM_METADATA_FORMAT,
				NATIVE_STREAM_METADATA_FORMAT_NAME, NATIVE_STREAM_METADATA_FORMAT_CLASSNAME, EXTRA_STREAM_METADATA_FORMAT_NAMES, EXTRA_STREAM_METADATA_FORMAT_CLASSNAMES,
				SUPPORTS_STANDARD_IMAGE_METADATA_FORMAT, NATIVE_IMAGE_METADATA_FORMAT_NAME, NATIVE_IMAGE_METADATA_FORMAT_CLASSNAME, EXTRA_IMAGE_METADATA_FORMAT_NAMES,
	...
	public boolean canDecodeInput(final Object source) throws IOException {
		...
		try {
			...
			if ((imageType != TGAConstants.NO_IMAGE) && (imageType != TGAConstants.COLOR_MAP) && (imageType != TGAConstants.TRUE_COLOR) && (imageType != TGAConstants.MONO)
					&& (imageType != TGAConstants.RLE_TRUE_COLOR) && (imageType != TGAConstants.RLE_COLOR_MAP) && (imageType != TGAConstants.RLE_MONO)) {
				return false;
			}
