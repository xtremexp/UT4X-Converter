...
public class T3DMatch {
    ...
    private void initialise(){
        ...
        list.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Bandages"}, null, new String[]{"HealthVial", "Bandages"}, new String[]{"MiniHealthPack"}, new String[]{"MiniHealthPack"}, new String[]{"UTPickupFactory_HealthVial"}, new String[]{"Health_Small_C"})
                .addConvP(UTGame.UT4, new Object[]{Z_OFFSET, 24d}));
        
        list.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Health", "UPakHealth", "RespawningHealth", "NaliFruit"}, new String[]{"ArtifactHealth","HealthPickup"}, new String[]{"MedBox", "NaliFruit"}, new String[]{"HealthCharger"}, new String[]{"HealthCharger"}, new String[]{"UTPickupFactory_MediumHealth"}, new String[]{"Health_Medium_C"})
                .addConvP(UTGame.UT4, new Object[]{Z_OFFSET, 24d}));
        ...
        list.add(iByGame(T3DPickup.class, UE4_RCType.SCENE_COMP.name, null, null, new String[]{"FlagBase"}, new String[]{"xRedFlagBase"}, new String[]{"xRedFlagBase"}, new String[]{"UTCTFRedFlagBase"}, new String[]{"UTRedFlagBase_C"})
        ...
        list.add(iByGame(T3DPickup.class, UE4_RCType.SCENE_COMP.name, null, null, new String[]{"FlagBase"}, new String[]{"xBlueFlagBase"}, new String[]{"xBlueFlagBase"}, new String[]{"UTCTFBlueFlagBase"}, new String[]{"UTBlueFlagBase_C"})
    ...
    private void initialisePowerUps(){
        ...
        // Items - Helmet
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, null, null, null, null, null, new String[]{"UTArmorPickup_Helmet"}, new String[]{UT4_CLS_PWRUP})
                .withP(UTGame.UT4, UT4_PROP_IT, "BlueprintGeneratedClass'/Game/RestrictedAssets/Pickups/Armor/Armor_Helmet.Armor_Helmet_C'"));
        
        // PowerUp - Armor
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Armor"}, new String[]{"ArtifactArmor"}, new String[]{"Armor", "Armor2"}, new String[]{"ShieldCharger"}, new String[]{"ShieldCharger"}, new String[]{"UTArmorPickup_Vest"}, new String[]{UT4_CLS_PWRUP})
                .withP(UTGame.UT4, UT4_PROP_IT, "BlueprintGeneratedClass'/Game/RestrictedAssets/Pickups/Armor/Armor_Chest.Armor_Chest_C'"));
        
        // PowerUp - ShieldBelt
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"ShielBelt", "PowerShield"}, null, new String[]{"UT_ShieldBelt", "ShielBelt", "PowerBelt"}, new String[]{"SuperShieldCharger"}, new String[]{"SuperShieldCharger"}, new String[]{"UTArmorPickup_ShieldBelt"}, new String[]{UT4_CLS_PWRUP})
        ...
        // PowerUp - JumpBoots
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"JumpBoots"}, null, new String[]{"UT_Jumpboots", "JumpBoots"}, null, null, new String[]{"UTPickupFactory_JumpBoots"}, new String[]{UT4_CLS_PWRUP})
        ...
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Amplifier"}, null, new String[]{"UDamage", "Amplifier"}, new String[]{"UDamageCharger"}, new String[]{"UDamageCharger"}, new String[]{"UTPickupFactory_UDamage"}, new String[]{UT4_CLS_PWRUP})
        ...
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Invisibility"}, new String[]{"ArtifactInvisibility"}, new String[]{"Invisibility", "UT_Invisibility", "UT_Stealth"}, null, null, new String[]{"UTPickupFactory_Invisibility"}, new String[]{UT4_CLS_PWRUP})
                .withP(UTGame.UT4, UT4_PROP_IT, "BlueprintGeneratedClass'/Game/RestrictedAssets/Pickups/Powerups/BP_Invis.BP_Invis_C'"));
        
        // PowerUp - Berserk
        gmPwrups.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, null, null, null, null, null, new String[]{"UTPickupFactory_Berserk"}, new String[]{UT4_CLS_PWRUP})
                .withP(UTGame.UT4, UT4_PROP_IT, "BlueprintGeneratedClass'/Game/RestrictedAssets/Pickups/Powerups/BP_Berserk.BP_Berserk_C'"));
    ...
    private void initialiseAmmos(){
        ...
        // Ammo - BioAmmo
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Sludge"}, null, new String[]{"BioAmmo", "Sludge"}, new String[]{"BioAmmoPickup"}, new String[]{"BioAmmoPickup"}, new String[]{"UTAmmo_BioRifle_Content", "UTAmmo_BioRifle"}, new String[]{"BioAmmoPickup_C"}));
        
        // Ammo - Minigun
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"Clip"}, null, new String[]{"Miniammo", "EClip"}, new String[]{"MinigunAmmoPickup"}, new String[]{"MinigunAmmoPickup"}, new String[]{"UTAmmo_Stinger"}, new String[]{"MinigunAmmoPickup_C"}));
        
        // Ammo - Flak
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"FlakBox", "FlakShellAmmo"}, null, new String[]{"FlakAmmo", "FlakBox", "FlakShellAmmo"}, new String[]{"FlakAmmoPickup"}, new String[]{"FlakAmmoPickup"}, new String[]{"UTAmmo_FlakCannon"}, new String[]{"FlakAmmoPickup_C"}));
        
        // Ammo - Rocket
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"RocketCan", "RLAmmo"}, new String[]{"ammoRocketLauncher"}, new String[]{"RocketPack", "RocketCan"}, new String[]{"RocketAmmoPickup"}, new String[]{"RocketAmmoPickup"}, new String[]{"UTAmmo_RocketLauncher"}, new String[]{"RocketAmmoPickup_C"}));
        
        // Ammo - Shock
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"ASMDAmmo"}, null, new String[]{"ShockCore", "ASMDAmmo"}, new String[]{"ShockAmmoPickup"}, new String[]{"ShockAmmoPickup"}, new String[]{"UTAmmo_ShockRifle"}, new String[]{"ShockAmmoPickup_C"}));
        
        // Ammo - Sniper
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, new String[]{"RifleAmmo", "RifleRound"}, new String[]{"ammoSniperRifle"}, new String[]{"BulletBox", "RifleAmmo", "RifleRound", "RifleShell"}, new String[]{"SniperAmmoPickup"}, new String[]{"SniperAmmoPickup"}, new String[]{"UTAmmo_SniperRifle"}, new String[]{"SniperAmmoPickup_C"}));
        
        // Ammo - LinkGun
        gmAmmos.add(iByGame(T3DPickup.class, UE4_RCType.CAPSULE.name, null, null, new String[]{"PAmmo"}, new String[]{"LinkAmmoPickup"}, new String[]{"LinkAmmoPickup"}, new String[]{"UTAmmo_LinkGun"}, new String[]{"LinkAmmoPickup_C"}));
    ...
    private void initialiseWeapons(UTGame inputGame){
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"Eightball"}, new String[]{"weaponRocketLauncher", "weaponRocketLauncherGimp"}, new String[]{"Eightball", "UT_Eightball"}, new String[]{"xWeaponBase"}, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.RocketLauncher'"));
        ...
        // Weapons - Flak Cannon
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"FlakCannon"}, null, new String[]{"UT_FlakCannon", "FlakCannon"}, new String[]{"xWeaponBase"}, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.FlakCannon'"));
        
        // Weapons - Enforcer
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"AutoMag"}, new String[]{"weaponAssaultRifle"}, new String[]{"AutoMag", "enforcer", "doubleenforcer"}, new String[]{"xWeaponBase"}, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.AssaultRifle'"));
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, null, null, new String[]{"ImpactHammer"}, null, null, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2004, WEAPON_TYPE, "Class'XWeapons.ShieldGun'")
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.ShieldGun'"));
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"RocketLauncher"}, null, new String[]{"WarheadLauncher"}, null, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.Redeemer'"));
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"ASMD"}, null, new String[]{"ShockRifle", "ASMD"}, null, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2004, WEAPON_TYPE, "Class'XWeapons.ShockRifle'")
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.ShockRifle'"));
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"GESBioRifle"}, null, new String[]{"ut_biorifle", "GESBioRifle"}, null, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.BioRifle'"));
        
        // Weapons - Sniper
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"Rifle"}, new String[]{"weaponSniperRifle"}, new String[]{"SniperRifle", "Rifle"}, null, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                .withP(UTGame.UT4, WEAPON_TYPE, "BlueprintGeneratedClass'/Game/RestrictedAssets/Weapons/Sniper/BP_Sniper.BP_Sniper_C'")
                .withP(UTGame.UT2004, WEAPON_TYPE, "Class'XWeapons.SniperRifle'")
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.SniperRifle'")); // TODO handle as well UTClassic.ClassicSniperRifle
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, new String[]{"Minigun"}, null, new String[]{"minigun2", "Minigun"}, null, new String[]{"xWeaponBase"}, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.Minigun'"));
        ...
        gmWeapons.add(iByGame(pickupCls, UE4_RCType.CAPSULE.name, null, null, new String[]{"SuperShockRifle"}, null, null, null, new String[]{UT4_CLS_WPT})
                ...
                .withP(UTGame.UT2004, WEAPON_TYPE, "Class'XWeapons.SuperShockRifle'")
                .withP(UTGame.UT2003, WEAPON_TYPE, "Class'XWeapons.SuperShockRifle'"));
